...
let h800 = document.getElementById('800');
let h900 = document.getElementById('900');
let h1000 = document.getElementById('1000');
let h1100 = document.getElementById('1100');
let h1200 = document.getElementById('1200');
let h1300 = document.getElementById('1300');
let h1400 = document.getElementById('1400');
let h1500 = document.getElementById('1500');
let h1600 = document.getElementById('1600');
let h1700 = document.getElementById('1700');
let h1800 = document.getElementById('1800');
let h1900 = document.getElementById('1900');
let h2000 = document.getElementById('2000');
